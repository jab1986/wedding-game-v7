...
# Tutorial texts
var tutorial_texts := [
	"Use arrow keys or WASD to walk to Jenny",
...
func _create_amsterdam_environment() -> void:
	# This would be done in the editor, but showing structure here
	
	# Create evening sky gradient
	...
	# Add Amsterdam houses in background
